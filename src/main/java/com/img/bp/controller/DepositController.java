...
import com.img.bp.model.SearchDateRangeRequestDTO;
...
public class DepositController {
    ...
    public ResponseEntity<List<Point>> getAllPointsByPerson(@RequestBody final SearchDateRangeRequestDTO dto) {
        return new ResponseEntity<>(service.getAllPointsByPerson(dto.getFrom(), dto.getTo()), HttpStatus.FOUND);
    }
